...
$config['LicenseName'] = 'tomato.dev';
$config['LicenseKey'] = 'PQ5AWJBFJCCFQVS6XH5WE7TL4GRJBF87PZ';
...
//$web_url = dirname('http://'.$_SERVER['SERVER_NAME'].$_SERVER["REQUEST_URI"]);

date_default_timezone_set('PRC');
$upl_time = date('Ym',time());
...
// $baseUrl = $url_upload.'assets/'.$upl_time.'/';
$baseUrl = '/assets/';//.$upl_time.'/';
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . 'files/'.$upl_time,
		'directory' => $baseDir . 'files/'.$upl_time,
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl . 'images/'.$upl_time,
		'directory' => $baseDir . 'images/'.$upl_time,
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Flash',
		'url' => $baseUrl . 'flash/'.$upl_time,
		'directory' => $baseDir . 'flash/'.$upl_time,
		'maxSize' => 0,
