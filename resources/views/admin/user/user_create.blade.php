                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" name="email"
                                                       placeholder="Enter email" value="{{ Input::old('email') }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="name">登录用户名
                                                    <small class="text-red">*</small>
                                                </label>
                                                <input type="text" class="form-control" name="name"
                                                       placeholder="Enter name" value="{{ Input::old('name') }}">
                                            </div>
                                    ...
                                    <div class="tab-pane" id="tab_2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nickname"
                                                   placeholder="Enter nickname" value="{{ Input::old('nickname') }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="phone">手机号码</label>
                                            <input type="text" class="form-control" name="phone"
                                                   placeholder="Enter phone" value="{{ Input::old('phone') }}">
                                        </div>
