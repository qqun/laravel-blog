    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1 id="action" data-url="{{ url('admin/tags/') }}">
                    标签管理
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                ...
                <a href="{{ url('admin/tags/create') }}" class="btn btn-success margin-bottom">新增标签</a>
                @include('../admin/alert')
                                        ...
                                        @foreach($data as $dat)
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ URL('/admin/tags/'.$dat->id.'/edit') }}" class="active"
                                                       ui-toggle-class>
