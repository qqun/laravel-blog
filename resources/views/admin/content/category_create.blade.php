                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       placeholder="请输入分类名称" name="title" {{ Input::old('title') }}>
                                            </div>

                                            <div class="form-group">
                                                <label>别名</label>
                                                <input type="text" class="form-control"
                                                       placeholder="" name="alias" value="{{ Input::old('alias') }}">
                                            </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter seo keywords"
                                                       name="keywords" value="{{ Input::old('keywords') }}">
                                            </div>
                                            ...
                                            <div class="form-group none">
                                                <label>跳转链接</label>
                                                <input type="text" class="form-control"
                                                       placeholder="" name="http" value="{{ Input::old('http') }}">
                                            </div>

                                            <div class="form-group none">
                                                <label>排序</label>
                                                <input type="text" class="form-control"
                                                       placeholder="" name="sort" value="{{ Input::old('sort') }}">
                                            </div>
                                        </div>
                                    </div><!-- /.tab-pane -->
